...
app.use(
  "/api/supervisor",
  require("./src/modules/supervisor/supervisor.routes"),
);
...
app.use(
  "/api/work-sessions",
  require("./src/modules/work-sessions/work-sessions.routes"),
);
// Chat routes ──────────────────────────────────────────────────────────
...
app.use(
  "/api/audio-room",
  require("./src/modules/AUDIO_ROOM/livekit/routes/livekit.routes"),
);
app.use(
  "/api/audio-room",
  require("./src/modules/AUDIO_ROOM/room-config/roomConfig.routes"),
);
app.use(
  "/api/audio-room",
  require("./src/modules/AUDIO_ROOM/room-start/roomStart.routes"),
);
app.use(
  "/api/audio-room",
  require("./src/modules/AUDIO_ROOM/room-end/roomEnd.routes"),
);
app.use(
  "/api/audio-room",
  require("./src/modules/AUDIO_ROOM/room-join/roomJoin.routes"),
);
app.use(
  "/api/audio-room",
  require("./src/modules/AUDIO_ROOM/room-list/roomList.routes"),
);
app.use(
  "/api/audio-room",
  require("./src/modules/AUDIO_ROOM/room-details/roomDetails.routes"),
);
app.use(
  "/api/audio-room",
  require("./src/modules/AUDIO_ROOM/room-leave/roomLeave.routes"),
);
app.use(
  "/api/audio-room",
  require("./src/modules/AUDIO_ROOM/room-raise-hand/roomRaiseHand.routes"),
);
app.use(
  "/api/audio-room",
  require("./src/modules/AUDIO_ROOM/room-hand-requests/roomHandRequests.routes"),
);
app.use(
  "/api/audio-room",
...
app.use(
  "/api/audio-room",
  require("./src/modules/AUDIO_ROOM/speaker-downgrade/speakerDowngrade.routes"),
);
app.use(
  "/api/audio-room",
