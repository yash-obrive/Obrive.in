...
router.get(
  "/nearest",
  zodValidate({ part: "query", schema: NearestEventsQuerySchema }),
  ctrl.getNearestEvents,
);
router.get(
  "/range",
  zodValidate({ part: "query", schema: EventsByRangeQuerySchema }),
  ctrl.getEventsByDateRange,
);
...
router.post(
  ...
  zodValidate({ part: "body", schema: CreateEventBodySchema }),
  ctrl.createEvent,
);
router.put(
  "/:id",
