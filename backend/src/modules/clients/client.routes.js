...
router.put(
  "/profile",
  zodValidate({ part: "body", schema: UpdateClientProfileBodySchema }),
  ctrl.updateProfile,
);
...
router.get(
  "/projects/:id",
  zodValidate({ part: "params", schema: ClientProjectIdParamSchema }),
  ctrl.getProjectById,
);
router.post(
  "/projects/request",
  zodValidate({ part: "body", schema: RequestProjectBodySchema }),
  ctrl.requestProject,
);
