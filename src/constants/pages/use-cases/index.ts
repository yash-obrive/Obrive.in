import { IMAGES, IMAGES_META, ICONS, ICONS_META, OBNEST_IMAGES, OBNEST_IMAGES_META, OBMOVE_IMAGES, OBMOVE_IMAGES_META, OBNAVI_IMAGES, OBNAVI_IMAGES_META } from "@/assets/images";
...
const PLACEHOLDER_HOW_IT_WORKS = [
  {
    ...
    description: "This is a placeholder description for how this use case is implemented.",
...
const OBNEST_HOW_IT_WORKS = [
  {
    ...
    description: "Share your floorplans, 3D models, or architectural drawings. Our platform transforms them into immersive MR/VR-ready environments.",
  ...
  },
  {
    ...
    description: "Digitally stage interiors with furniture, lighting, and finishes—or allow buyers to customize designs in real time.",
  ...
  },
  {
    ...
    description: "Publish your properties directly to the marketplace, where users can explore through VR headsets, MR devices, or smartphones.",
  ...
  },
  {
    ...
    description: "Invite clients, architects, and stakeholders into the same property tour—annotate, adjust, and finalize design decisions together.",
  ...
  },
  {
    ...
    description: "Track tour engagement, popular layouts, and buyer preferences through your analytics dashboard, helping you refine offerings.",
  ...
  },
  {
    ...
    description: "Gain access to a real-time dashboard with insights on space utilization, occupancy trends, customer behaviors, and revenue opportunities.",
...
const OBNEST_KEY_BENEFITS = [
  {
    ...
    description: "Virtual tours and immersive walkthroughs help buyers decide faster, reducing the need for repeated site visits.",
    src: ICONS.BOX_CHECK_ICON,
    srcMeta: ICONS_META.BOX_CHECK_ICON,
  },
  {
    title: "Cost Savings on Staging & Marketing",
    description: "Skip expensive physical staging—digitally stage, update, and showcase properties instantly.",
    src: ICONS.BOX_CHECK_ICON,
    srcMeta: ICONS_META.BOX_CHECK_ICON,
  },
  {
    title: "Global Reach & Remote Accessibility",
    description: "Attract international investors and remote buyers with MR/VR tours available anytime, anywhere.",
    src: ICONS.BOX_CHECK_ICON,
    srcMeta: ICONS_META.BOX_CHECK_ICON,
  },
  {
    title: "Deeper Client Engagement",
    description: "Immersive, interactive experiences build stronger emotional connections and trust in the property.",
    src: ICONS.BOX_CHECK_ICON,
    srcMeta: ICONS_META.BOX_CHECK_ICON,
  },
  {
    title: "Data-Driven Insights",
    description: "Understand buyer preferences with analytics on engagement, popular layouts, and time spent in spaces.",
    src: ICONS.BOX_CHECK_ICON,
    srcMeta: ICONS_META.BOX_CHECK_ICON,
  },
  {
    title: "Competitive Advantage",
    description: "Differentiate your business as innovative and future-ready, standing out in crowded real estate markets.",
    src: ICONS.BOX_CHECK_ICON,
    srcMeta: ICONS_META.BOX_CHECK_ICON,
  }
] as const;
...
const OBMOVE_HOW_IT_WORKS = [
  {
    ...
    description: "From home, mobile, VR headset, or digital kiosk—customers instantly step into a life-sized 3D showroom.",
  ...
  },
  {
    ...
    description: "Walk around models, examine details from every angle—as if the product were physically there.",
  ...
  },
  {
    ...
    description: "Change trims, colors, and accessories in real time. Every choice updates the model instantly.",
  ...
  },
  {
    ...
    description: "Use AR mode to place the object in your environment—helping buyers imagine ownership.",
  ...
  },
  {
    ...
    description: "Switch between models, view features side by side, and explore upgrades to make an informed choice.",
  ...
  },
  {
    ...
    description: "Track which models customers explore most. Measure customization trends, time spent, and AR interactions.",
...
const OBMOVE_KEY_BENEFITS = [
  {
    ...
    description: "Walk around life-sized objects, step inside, and experience interiors in detail.",
    src: ICONS.BOX_CHECK_ICON,
    srcMeta: ICONS_META.BOX_CHECK_ICON,
  },
  {
    title: "Personalized Customization",
    description: "Instantly change trims, colors, and features to design your ideal configurations.",
    src: ICONS.BOX_CHECK_ICON,
    srcMeta: ICONS_META.BOX_CHECK_ICON,
  },
  {
    title: "AR Visualization at Home",
    description: "Place items in your physical space for a realistic ownership preview.",
    src: ICONS.BOX_CHECK_ICON,
    srcMeta: ICONS_META.BOX_CHECK_ICON,
  },
  {
    title: "Smarter Decisions",
    description: "Compare models side by side and explore upgrades with full clarity.",
    src: ICONS.BOX_CHECK_ICON,
    srcMeta: ICONS_META.BOX_CHECK_ICON,
  },
  {
    title: "Convenient Access Anywhere",
    description: "Experience the catalog from home, mobile, VR headsets, or physical kiosks.",
    src: ICONS.BOX_CHECK_ICON,
    srcMeta: ICONS_META.BOX_CHECK_ICON,
  }
] as const;
...
const OBNAVI_HOW_IT_WORKS = [
  {
    ...
    description: "Users open the app or connect via supported AR glasses. The system detects their location within the indoor space using indoor positioning technology.",
  ...
  },
  {
    ...
    description: "Users search for an item or location. The system instantly maps the shortest, most efficient route. Personalized recommendations appear in AR along the way.",
  ...
  },
  {
    ...
    description: "Dynamic AR arrows, overlays, and visual cues guide users through aisles and corridors, making navigation intuitive and frictionless.",
  ...
  },
  {
    ...
    description: "By pointing their device at a physical location, users unlock immersive details, reviews, availability, and suggestions, right in their view.",
  ...
  },
  {
    ...
    description: "Users can save items, connect directly with loyalty programs, and digital checkout. Businesses gain valuable insights through the analytics dashboard.",
  ...
  },
  {
    ...
    description: "Hands-free navigation with voice-guided assistants. Gesture-based interaction with AR prompts for convenience and accessibility.",
...
const OBNAVI_KEY_BENEFITS = [
  {
    ...
    description: "Find products and locations quickly with real-time AR/MR guidance.",
    src: ICONS.BOX_CHECK_ICON,
    srcMeta: ICONS_META.BOX_CHECK_ICON,
  },
  {
    title: "Unique Journey",
    description: "Get tailored recommendations and exclusive context-aware offers.",
    src: ICONS.BOX_CHECK_ICON,
    srcMeta: ICONS_META.BOX_CHECK_ICON,
  },
  {
    title: "Instant Information",
    description: "Access reviews, features, stock availability, and promotions with a simple scan.",
    src: ICONS.BOX_CHECK_ICON,
    srcMeta: ICONS_META.BOX_CHECK_ICON,
  },
  {
    title: "Time-Saving & Stress-Free",
    description: "Spend less time searching and wandering, and more time achieving your goal.",
    src: ICONS.BOX_CHECK_ICON,
    srcMeta: ICONS_META.BOX_CHECK_ICON,
  },
  {
    title: "Immersive & Engaging",
    description: "Turn navigation into an interactive experience that feels futuristic yet intuitive.",
    src: ICONS.BOX_CHECK_ICON,
    srcMeta: ICONS_META.BOX_CHECK_ICON,
  }
] as const;
...
export const AR_PRODUCT_VISUALIZATION = {
  hero: {
    ...
    description: "Bring products to life by visualizing them in real-world environments before purchase.",
    description2: "Project 3D models, annotations, and contextual overlays directly onto physical environments to eliminate guesswork and improve spatial understanding.",
    ctaButtons: {
...
export const VIRTUAL_TRAINING = {
  hero: {
    ...
    description: "Immersive, risk-free training environments for complex scenarios and equipment.",
    description2: "Replace costly manual methods with engaging, efficient simulations. From healthcare training to manufacturing workflows, our VR platforms provide realistic guidance.",
    ctaButtons: {
...
export const DIGITAL_TWINS = {
  hero: {
    title: "Digital Twins",
    description: "Create exact virtual replicas of physical assets, systems, or environments.",
...
export const VIRTUAL_SHOWROOMS = {
  hero: {
    ...
    description: "Interactive, 3D retail spaces allowing customers to explore products remotely.",
    description2: "Redefining sales with an MR/VR showroom that delivers immersive, personalized experiences—building buyer confidence and transforming the buying journey.",
    ctaButtons: {
...
export const INDOOR_NAVIGATION = {
  hero: {
    ...
    description: "AR-powered wayfinding solutions for large complex indoor environments.",
    description2: "Transform navigation—replacing confusing layouts with immersive AR/MR navigation, personalized discovery, and seamless assistance, so users always find what they need.",
    ctaButtons: {
...
export const THREE_D_PRODUCT_CONFIGURATION = {
  hero: {
    ...
    description: "Allow customers to customize and interact with 3D product models in real-time.",
    description2: "Placeholder secondary description for 3D product configurators.",
    ctaButtons: {
...
export const VIRTUAL_PROPERTY_TOURS = {
  hero: {
    ...
    description: "Immersive walkthroughs of real estate properties and architectural designs.",
    description2: "Using MR and VR to deliver immersive, true-to-life property experiences that inspire confidence and accelerate decisions.",
    ctaButtons: {
...
export const REMOTE_ASSISTANCE = {
  hero: {
    ...
    description: "AR-guided visual support and collaboration for field technicians and experts.",
