...
export const VR_DEVELOPMENT_INDUSTRIES: import("../../../types/solutions").SolutionIndustriesContent = {
  "slug": "virtual-reality-development",
  "hero": {
    "title": "Virtual Reality Across Industries",
    "description": "VR Solutions Designed Around Industry-Specific Outcomes. Virtual Reality becomes more valuable when it is designed around the realities of a specific industry. Obrive develops configurable VR experiences for workforce training, simulation, visualization, collaboration, customer engagement, product demonstration, safety and immersive learning."
  },
  "industries": [
    {
      "id": "automotive-mobility",
      "title": "Automotive & Mobility",
      "description": "Create immersive vehicle experiences, virtual showrooms, design reviews, manufacturing simulations, technician training, dealership experiences, safety scenarios and customer product demonstrations."
    },
    {
      "id": "manufacturing-industrial-engineering",
      "title": "Manufacturing & Industrial Engineering",
      "description": "Support operator training, assembly simulation, maintenance rehearsal, factory visualization, safety training, quality workflows, digital twins and remote collaboration."
    },
    {
      "id": "healthcare-medical",
      "title": "Healthcare & Medical",
      "description": "Develop VR experiences for medical education, anatomy visualization, clinical skills, procedure rehearsal, patient education, equipment training and facility walkthroughs. Solutions can be designed around relevant privacy, safety and regulatory requirements."
    },
    {
      "id": "pharmaceuticals-life-sciences",
      "title": "Pharmaceuticals & Life Sciences",
      "description": "Use VR for laboratory training, manufacturing simulations, equipment procedures, scientific visualization, facility walkthroughs, product education and field enablement."
    },
    {
      "id": "retail-ecommerce",
      "title": "Retail & eCommerce",
      "description": "Create virtual stores, immersive product demonstrations, virtual showrooms, customer education, product configuration and branded retail environments."
    },
    {
      "id": "consumer-goods-brands",
      "title": "Consumer Goods & Brands",
      "description": "Turn product launches, brand storytelling, virtual events, experiential campaigns and customer education into immersive experiences."
    },
    {
      "id": "real-estate-property",
      "title": "Real Estate & Property",
      "description": "Visualize properties, interiors and developments at scale through VR tours, architectural walkthroughs, virtual staging, buyer experiences and stakeholder presentations."
    },
    {
      "id": "architecture-engineering-construction",
      "title": "Architecture, Engineering & Construction",
      "description": "Use VR for design review, BIM visualization, construction coordination, safety training, site simulation, stakeholder walkthroughs and project communication."
    },
    {
      "id": "education-edtech",
      "title": "Education & EdTech",
      "description": "Create immersive lessons, virtual laboratories, vocational training, campus experiences, technical learning, history experiences and hands-on simulations."
    },
    {
      "id": "energy-utilities-infrastructure",
      "title": "Energy, Utilities & Infrastructure",
      "description": "Support asset visualization, maintenance rehearsal, field training, safety scenarios, emergency response, infrastructure walkthroughs and remote collaboration."
    },
    {
      "id": "oil-gas",
      "title": "Oil & Gas",
      "description": "Enable equipment visualization, maintenance simulation, safety training, inspection rehearsal, remote expert support and operational knowledge transfer."
    },
    {
      "id": "mining-natural-resources",
      "title": "Mining & Natural Resources",
      "description": "Use VR for equipment operation training, mine-site visualization, safety simulations, maintenance, inspection and workforce enablement in demanding environments."
    },
    {
      "id": "aerospace-aviation",
      "title": "Aerospace & Aviation",
      "description": "Develop VR experiences for assembly training, component visualization, maintenance, inspection, technical documentation, cockpit or cabin training and engineering collaboration."
    },
    {
      "id": "logistics-warehousing-supply-chain",
      "title": "Logistics, Warehousing & Supply Chain",
      "description": "Support warehouse simulation, picking and loading training, facility visualization, safety procedures, equipment training and operational workflow rehearsal."
    },
    {
      "id": "travel-tourism-hospitality",
      "title": "Travel, Tourism & Hospitality",
      "description": "Create virtual destination experiences, hotel and resort tours, cultural storytelling, travel previews, attraction experiences and immersive marketing."
    },
    {
      "id": "media-entertainment-gaming",
      "title": "Media, Entertainment & Gaming",
      "description": "Build interactive storytelling, games, virtual production concepts, immersive entertainment, live-event experiences, fan engagement and branded VR activations."
    },
    {
      "id": "sports-fitness",
      "title": "Sports & Fitness",
      "description": "Develop athlete training simulations, fan experiences, venue walkthroughs, equipment visualization, coaching environments and branded immersive activations."
    },
    {
      "id": "banking-financial-services-insurance",
      "title": "Banking, Financial Services & Insurance",
      "description": "Explore VR for immersive customer education, property and asset visualization, workforce training, virtual branch concepts, claims training and selected collaboration experiences."
    },
    {
      "id": "telecommunications",
      "title": "Telecommunications",
      "description": "Support network planning visualization, technician training, equipment simulations, retail demonstrations, field-service training and immersive customer education."
    },
    {
      "id": "agriculture-agritech",
      "title": "Agriculture & AgriTech",
      "description": "Create VR experiences for equipment training, farm and field visualization, agricultural education, safety training and remote knowledge transfer."
    },
    {
      "id": "government-public-sector",
      "title": "Government & Public Sector",
      "description": "Design VR for public education, emergency preparedness, infrastructure visualization, workforce training, cultural heritage, defense-adjacent training where appropriate, museums and citizen experiences."
    },
    {
      "id": "corporate-learning-professional-services",
      "title": "Corporate Learning & Professional Services",
      "description": "Build leadership simulations, soft-skills training, communication practice, sales training, onboarding, client demonstrations and collaborative learning environments."
    }
  ],
  "footerText": "Our industry solutions are not limited to these sectors. We can adapt the same VR foundations—real-time 3D, immersive UX, simulation, AI, spatial interaction, networking, analytics and enterprise integration—to new industries and specialized environments.",
  "globalDelivery": {
    "title": "Global VR Delivery",
    "subtitle": "Build Once. Localize, Integrate and Scale Worldwide.",
    "description": "Obrive is positioned to support organizations operating across markets, languages, devices, learning requirements and regulatory environments. We design VR solutions that can be localized for different regions while maintaining a consistent product, training and brand experience.",
    "items": [
