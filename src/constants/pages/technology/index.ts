...
export const MIXED_REALITY = {
  hero: {
    ...
    description2:
      "Placeholder secondary description for Mixed Reality technology.",
    ctaButtons: {
      primary: "Explore MR",
      secondary: "SCHEDULE A CONSULTATION",
    },
...
export const EXTENDED_REALITY = {
  hero: {
    ...
    description2:
      "Placeholder secondary description for Extended Reality technology.",
    ctaButtons: {
      primary: "Explore XR",
      secondary: "SCHEDULE A CONSULTATION",
    },
...
export const DIGITAL_TWINS = {
  hero: {
    ...
    description2:
      "Placeholder secondary description for Digital Twins technology.",
    ctaButtons: {
...
export const AI_IMMERSIVE_TECHNOLOGY = {
  hero: {
    ...
    description2:
      "Placeholder secondary description for AI + Immersive Technology.",
    ctaButtons: {
