...
export const OBPARK_QUOTES = [
  {
    quote: `"AR and MR-based navigation systems like Obpark represent a significant step forward in intelligent transportation solutions. By combining spatial computing with real-time data, these systems improve parking efficiency, enhance user convenience, and contribute to smarter urban mobility ecosystems."`,
