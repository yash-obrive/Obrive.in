...
export const AI_CONSULTING_KEY_BENEFITS = [
  {
    title: "Turn AI Ambition Into Business Value",
    description:
  ...
  {
    title: "Generative AI & Intelligent Knowledge",
    description:
...
export const AI_CONSULTING_SIDEBAR_LINKS = [
  { id: "ai-consulting-services", label: "AI Consulting Services" },
  {
    ...
    label: "AI-Era Consulting Capabilities",
  },
  {
    id: "global-ai-consulting-delivery",
    label: "Global AI Consulting Delivery",
  },
  {
  ...
  },
  {
    ...
    label: "What Makes an AI Consulting Program Successful?",
  },
  {
    id: "why-choose-obrive-for-ai-consulting",
    label: "Why Choose Obrive for AI Consulting?",
  },
  {
    id: "business-outcomes-ai-consulting-can-support",
    label: "Business Outcomes AI Consulting Can Support",
  },
] as const;
...
export const AI_CONSULTING_INDUSTRIES = [
  {
    ...
    description:
      "AI for vehicle intelligence, manufacturing, quality, predictive maintenance, mobility operations, customer experience and intelligent service workflows.",
  },
  {
    id: "manufacturing-industrial-engineering",
    title: "Manufacturing & Industrial Engineering",
    description:
      "AI opportunity mapping across production, quality, maintenance, engineering knowledge, supply chain, safety and operational decision support.",
  },
  {
    id: "healthcare-medical",
    title: "Healthcare & Medical",
    description:
      "AI strategy for clinical-adjacent workflows, patient experience, documentation, knowledge access, operations and decision support with appropriate human oversight.",
  },
  {
    id: "pharmaceuticals-life-sciences",
    title: "Pharmaceuticals & Life Sciences",
    description:
      "AI opportunities across research, documentation, knowledge management, quality, operations and commercial intelligence with strong governance.",
  },
  {
    id: "retail-ecommerce",
    title: "Retail & eCommerce",
    description:
      "AI for personalization, product discovery, customer service, merchandising, demand intelligence, content operations and conversion journeys.",
  },
  {
    id: "consumer-goods-brands",
    title: "Consumer Goods & Brands",
    description:
      "AI strategy across marketing, consumer insights, product knowledge, demand planning, customer engagement and brand operations.",
  },
  {
    id: "real-estate-property",
    title: "Real Estate & Property",
    description:
      "AI for property intelligence, lead qualification, document analysis, customer engagement, asset operations and portfolio decision support.",
  },
  {
    id: "architecture-engineering-construction",
    title: "Architecture, Engineering & Construction",
    description:
      "AI for project knowledge, documentation, design workflows, estimation, compliance support, field intelligence and operational coordination.",
  },
  {
    id: "education-edtech",
    title: "Education & EdTech",
    description:
      "AI for learning support, content intelligence, knowledge access, personalization, administration and learner engagement with appropriate safeguards.",
  },
  {
    id: "energy-utilities-infrastructure",
    title: "Energy, Utilities & Infrastructure",
    description:
      "AI consulting for asset intelligence, predictive maintenance, operations, customer service, planning, knowledge systems and infrastructure decision support.",
  },
  {
    id: "oil-gas",
    title: "Oil & Gas",
    description:
      "AI opportunities across engineering knowledge, asset performance, maintenance, safety, documentation, operations and technical decision support.",
  },
  {
    id: "mining-natural-resources",
    title: "Mining & Natural Resources",
    description:
      "AI for equipment intelligence, operational analytics, safety, document knowledge, planning, maintenance and resource workflows.",
  },
  {
    id: "aerospace-aviation",
    title: "Aerospace & Aviation",
    description:
      "AI strategy for engineering knowledge, maintenance, operations, customer support, documentation and high-assurance workflows.",
  },
  {
    id: "logistics-warehousing-supply-chain",
    title: "Logistics, Warehousing & Supply Chain",
    description:
      "AI for demand forecasting, route and inventory intelligence, warehouse operations, document processing, customer service and exception management.",
  },
  {
    id: "travel-tourism-hospitality",
    title: "Travel, Tourism & Hospitality",
    description:
      "AI for customer assistance, itinerary intelligence, personalization, operations, knowledge management and service workflows.",
  },
  {
    id: "media-entertainment-gaming",
    title: "Media, Entertainment & Gaming",
    description:
      "AI for content intelligence, audience understanding, personalization, production workflows, discovery and interactive experiences.",
  },
  {
    id: "sports-fitness",
    title: "Sports & Fitness",
    description:
      "AI for fan engagement, content, operations, personalization, performance analytics and intelligent customer experiences.",
  },
  {
    id: "banking-financial-services-insurance",
    title: "Banking, Financial Services & Insurance",
    description:
      "AI for knowledge access, document intelligence, service operations, risk workflows, customer support and analytics with rigorous governance.",
  },
  {
    id: "telecommunications",
    title: "Telecommunications",
    description:
      "AI for network operations, support, enterprise services, knowledge systems, customer experience and operational intelligence.",
  },
  {
    id: "agriculture-agritech",
    title: "Agriculture & AgriTech",
    description:
      "AI for crop intelligence, equipment, forecasting, field operations, advisory systems, supply chains and practical decision support.",
  },
  {
    id: "government-public-sector",
    title: "Government & Public Sector",
    description:
      "AI strategy for citizen information, document workflows, knowledge access, service operations and administrative efficiency with transparency and oversight.",
  },
  {
    id: "corporate-learning-professional-services",
    title: "Corporate Learning & Professional Services",
    description:
      "AI for enterprise knowledge, research, training, consulting workflows, document intelligence, proposal support and productivity.",
  },
];
...
export const AI_CONSULTING_INDUSTRIES_CONTENT: SolutionIndustriesContent = {
  ...
  extraBlocks: [
    {
      ...
      label: "",
      items: [
        "Industry-specific AI opportunity discovery",
        "Conversational and natural-language AI use cases",
        "Generative AI and enterprise knowledge systems",
        "AI agents and copilots with controlled permissions",
        "Entity-aware and knowledge-driven AI architecture",
        "AI-assisted document and information discovery",
        "Workflow automation and human-in-the-loop design",
        "AI product and customer-experience strategy",
        "Predictive analytics and decision support",
        "Computer vision and intelligent document processing",
        "AI-assisted analytics and opportunity identification",
        "Human review for consequential information",
        "Transparent treatment of uncertainty and limitations",
        "Privacy-aware AI workflows and governance",
        "Evaluation, monitoring and continuous optimization",
      ],
      footer:
        "AI should be applied according to each industry's users, data permissions, business rules and risk. AI-era consulting means finding meaningful applications for intelligence and building trustworthy systems—not simply adding AI features for their own sake.",
    },
  ],
  globalDelivery: {
    title: "Global AI Consulting Delivery",
    subtitle: "",
    description:
      "Obrive supports local, national and international organizations, including multilingual environments, regional operating requirements, distributed teams, multiple business units and scalable AI governance. Consulting can begin with one business unit or use case and expand into an enterprise AI portfolio.",
    items: [],
  },
  technologyCapabilities: {
    ...
    items: [
      ...
      "Knowledge graphs and structured knowledge where appropriate",
  ...
  footerText:
    "Our industry solutions are not limited to these sectors. Obrive can adapt AI consulting to specialized terminology, regulations, data permissions, technical documentation, product catalogs, customer journeys, operating models, geographic markets and emerging business models.",
};
