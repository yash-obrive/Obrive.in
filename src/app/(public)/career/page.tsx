...
export const metadata: Metadata = {
  ...
  title: "Careers at Obrive | AR, VR & Spatial Computing Jobs in Bangalore",
  ...
  openGraph: {
    ...
    title: "Careers at Obrive | Immersive Technology Jobs",
    description:
  ...
  twitter: {
    ...
    title: "Careers at Obrive | AR/VR & Spatial Computing Jobs",
    description:
    ...
    <SmoothScrollProvider>
      <div>
        ...
        <FullWidthSection backgroundColor="none">
          <section>
            <SectionHeader
              title="WE REDEFINED THE FUTURE"
              iconText="GIVING BACK"
            />
            <div className="mt-20">
        ...
        {/* career section */}
        <section
          className="bg-gradient mt-30 flex flex-col gap-20 max-md:gap-10 items-center p-20 max-md:p-8"
          id="career"
        >
