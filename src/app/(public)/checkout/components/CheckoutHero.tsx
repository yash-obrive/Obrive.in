  ...
  return (
    ...
    >
      ...
      <div className="max-w-[1280px] mx-auto relative z-10 text-center">
        <h1
          className={`${FONTS.microgrammaBold.className} text-secondary sm:leading-20 text-4xl sm:text-5xl md:text-6xl max-w-[90vw] sm:max-w-3xl md:max-w-4xl mx-auto break-words text-balance mb-6 uppercase`}
        >
          Secure Checkout
        </h1>
