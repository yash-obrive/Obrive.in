  ...
  const steps = [
    {
      ...
      description: "Choose a stream and package that matches the initial scope."
    },
    {
      number: "02",
      title: "Confirm scope",
      description: "Obrive validates requirements and issues the final SOW, timeline and invoice."
    },
    {
      number: "03",
      title: "Pay securely",
      description: "Customer pays through Razorpay; payment and invoice IDs are recorded."
    },
    {
      number: "04",
      title: "Build & deliver",
      description: "Project enters delivery with milestones, reviews, QA and final handoff."
    }
  ];
