    ...
    groups: [
      {
        ...
        images: [
          {
            url: "/certificates/Obrive-Icon-Trade-Mark 1.png",
            alt: "Obrive Trademark B",
          },
          {
            url: "/certificates/Obrive-Logo-Trade-Mark 1.png",
            alt: "Obrive Trademark Logo",
          },
        ],
      },
      {
        ...
        images: [
          {
            url: "/certificates/Obpark-Trade-Marked 1.png",
            alt: "Obrive Trademark Seal",
          },
          {
            url: "/certificates/Over-All-Trade-Marked-India 1.png",
            alt: "Font Copyright",
          },
          {
            url: "/certificates/Over-All-Trade-Marked-India 2.png",
            alt: "Rights Reserved Copyright",
          },
        ],
      },
    ],
    ...
    groups: [
      {
        ...
        images: [
          {
            url: "/certificates/NIC 62091 Compliance Recognition Badge 1.png",
            alt: "NIC Code 62091",
          },
        ],
      },
  ...
  sets: [
    {
      ...
      images: [
        {
          id: "iso-9001",
          url: "/certificates/hs1(1).png",
          alt: "ISO 9001 Quality Management",
        },
        {
          id: "iso-45001",
          url: "/certificates/hs1(2).png",
          alt: "ISO 45001 Health & Safety",
        },
        {
          id: "iso-27001-v1",
          url: "/certificates/hs1(3).png",
          alt: "ISO 27001 Security Management",
        },
        {
          id: "iso-27001-v2",
          url: "/certificates/hs1(4).png",
    ...
    },
    {
      ...
      images: [
        {
          id: "iso-9001-dup",
          url: "/certificates/hs2(1).png",
          alt: "ISO 9001 Quality Management",
        },
        {
          id: "iso-45001-dup",
          url: "/certificates/hs2(2).png",
          alt: "ISO 45001 Health & Safety",
        },
        {
          id: "iso-27001-v1-dup",
          url: "/certificates/hs2(3).png",
          alt: "ISO 27001 Security Management",
        },
        {
          id: "iso-27001-v2-dup",
          url: "/certificates/hs2(4).png",
          alt: "ISO 27001 Certified",
        },
      ],
    },
    ...
    <div className="min-h-screen bg-white  font-sans py-12 px-4 sm:px-8 mt-10">
      ...
      <main className="max-w-5xl mx-auto flex flex-col space-y-12">
        ...
        <header className="border-b  pb-6">
          <h1
            className={`${FONTS.microgrammaBold.className}  text-[#074139] text-2xl sm:text-3xl text-[#074139] tracking-wide`}
          >
            {pageHeader.title}
          </h1>
          <div
        ...
        {layoutRowsData.map((row) => (
          <React.Fragment key={row.id}>
            <section className="flex flex-col items-center text-center">
              {row.categoryTitle && (
                <h2
                  className={`${FONTS.microgrammaBold.className}  text-[#074139] text-lg sm:text-xl font-bold  mb-8 self-start`}
                >
                  {row.categoryTitle}
                </h2>
              )}
              ...
              <div
                className={`flex flex-wrap justify-center items-start w-full ${row.rowGap}`}
              >
                {row.groups.map((group) => (
                  ...
                  >
                    <h3
                      className={`${FONTS.microgrammaBold.className}  text-[#074139] text-xs sm:text-sm font-bold  mb-1`}
                    >
                      {group.heading}
                    </h3>
                    {group.heading &&
                    ...
                    <div
                      className={`flex flex-wrap items-center justify-center ${row.rowGap || "gap-4"} mt-2`}
                    >
                      {group.images.map((img, idx) => (
                        <div
                          key={idx}
                          className={`${group.id === "startup-india" ? "w-[208px] sm:w-[192px] h-[208px] sm:h-[192px]" : "w-[150px] sm:w-[136px] h-[150px] sm:h-[136px]"} flex items-center justify-center`}
                        >
                          <img
                            src={img.url}
                            alt={img.alt}
