  ...
  useEffect(() => {
    ...
    const fetchNotes = async () => {
      try {
        ...
        const mapped: NoteCard[] = json.data.map((note: any) => ({
          id: String(note.id),
          ...
          position: note.position != null ? Number(note.position) : undefined,
          user_id: note.user_id != null ? String(note.user_id) : undefined,
