...
export default function Header({
  ...
  isRefreshing = false,
  activeSection,
}: HeaderProps & { activeSection: string }) {
  return (
    <div className="flex-row flex justify-between p-2">
      <div className="w-1/2">
        ...
        <div>
          <p className="text-[14px] text-gray-500 mb-1 mt-5 font-semibold">
            Welcome back!
          </p>
          <h1 className="text-[37px] font-extrabold text-[#074139] sm:text-xl">
            {activeSection}
          </h1>
        </div>
      </div>
