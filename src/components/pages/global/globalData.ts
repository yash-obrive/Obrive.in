...
export const MARKETS_DATA: MarketItem[] = [
  {
    ...
    code: "in",
    href: "/in",
    cities: "Bengaluru · Mumbai · Delhi NCR · Hyderabad · Chennai · Pune · Ahmedabad · Kolkata · Jaipur · Kochi",
  },
  {
    flag: "🇺🇸",
    name: "United States",
    ...
    code: "us",
    href: "/us",
    cities: "New York · Los Angeles · San Francisco · Chicago · Dallas · Seattle · Austin · Boston · Miami",
  },
  {
    flag: "🇨🇦",
    name: "Canada",
