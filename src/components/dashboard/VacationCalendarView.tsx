import type { Employee, Leave } from "./Vacations";
        ...
        <div className="flex-1 flex items-center justify-between py-3 px-6 border-b border-gray-100">
          ...
          <div className="flex gap-3 text-blue-500">
            <button
              ...
              className="hover:text-blue-600 transition opacity-50 hover:opacity-100 font-bold"
            >
              ←
            </button>
            <button
        ...
        <div className="min-w-max flex flex-col">
          ...
          <div className="flex sticky top-0 z-30 bg-white border-b border-gray-100 w-full pt-1 pb-1">
            ...
            {daysArray.map((day) => (
              <div
                key={day}
                className="flex-shrink-0 w-[42px] flex flex-col items-center justify-center"
              >
                <span className="text-[12px] font-bold text-[#8ba3b8]">
                  {day}
                </span>
            ...
            {employees.map((employee) => (
              ...
              >
                ...
                {daysArray.map((day) => {
                  ...
                  if (leave?.leave_type === "work_remotely")
                    colorStr = "#7a62db"; // Blue-Purple (Remote)
