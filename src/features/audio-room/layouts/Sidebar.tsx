  ...
  return (
    <>
          ...
          return (
            ...
            >
              ...
              <span className="text-[9px] font-medium tracking-tight">
                {item.label.split(" ")[0]}{" "}
                {/* Truncating text length to keep layout safe on small screen displays */}
              </span>
            </button>
          );
        })}
      ...
      >
        ...
        <div
          className={`flex items-center border-b border-slate-100 px-3 py-2.5 min-h-[49px] ${isCollapsed ? "justify-center" : "justify-between"}`}
        >
          {!isCollapsed && (
